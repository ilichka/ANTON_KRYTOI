...
export const inOrderTraverseStrategy = (node: Node | null, cb: (value: number)=>void): void => {
        if (node != null) {
...
export const postOrderTraverseStrategy = (node: Node | null, cb: (value: number)=>void): void => {
        if (node != null) {
